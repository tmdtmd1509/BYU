...
public:
	...
	*	Adds bonus damage to the Robot's next attack (and only its next attack) equal to (strength  * ((current_energy/maximum_energy)^4)). !!!use double!!!
	...
	*
	*	Cleric: Healing Light					!!!mana and magic is different!!!
